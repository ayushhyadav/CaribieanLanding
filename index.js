...
const formDataSchema = new mongoose.Schema({
  ...
  phone: String,
  massage: String,
  imagePath: String // Add a field for storing the path to the uploaded image
});
...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, 'public/Images') // Specify the directory where files will be saved
  },
